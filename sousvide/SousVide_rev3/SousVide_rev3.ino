...
/*
  ...
  */
  ...
  targetTime = 40;
  actualTime = (long) ((int)targetTime);
...
void timer() 
{
    if (tcurrent - previousMillis > timeInterval) 
    { 
        if (actualTime != 0)
        {
          previousMillis = tcurrent;
          actualTime = actualTime * timeInterval;
          actualTime = (actualTime - timeInterval) / timeInterval;
        }
        else
        {
          actualTime = 0;
